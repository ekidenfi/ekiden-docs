...
- **Public** — streams publicly available market data, including order books, trades, tickers, candlesticks, funding rates, liquidations, and other market events.
...
For complete channel definitions, message schemas, payload formats, and interactive examples, see the [**WebSocket Reference**](../websocket-api/public).