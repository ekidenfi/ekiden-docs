...
description: Ekiden SDK initialization in TypeScript, Python, and Rust.
---
...
|-------------|--------------|--------------------------|-----------------------------|
| Mainnet     | mainnet      | https://api.ekiden.io    | wss://ws.ekiden.io          |
| Testnet     | testnet      | https://testnet.ekiden.io | wss://testnet-ws.ekiden.io  |
