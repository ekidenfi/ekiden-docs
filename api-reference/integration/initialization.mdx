...
description: "This page explains how to initialize the Ekiden SDK in TypeScript. Initialization sets up your client to interact with Ekiden's REST and WebSocket APIs. You can operate in either public mode (read-only access) or authenticated mode (private endpoints and trading)."
---
...
| Staging | testnet | [https://api.canton.ekiden.fi/api/v1](https://api.canton.ekiden.fi/api/v1) | wss://api.canton.ekiden.fi/ws |
