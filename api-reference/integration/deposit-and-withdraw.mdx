...
Ekiden uses Canton to manage collateral for trading.

Users can deposit supported assets into their funding account and withdraw available collateral.
...
Additional assets may be added in future releases.

## Deposits

Deposit functionality is available through the TypeScript SDK and Canton integration.

Detailed integration examples will be added once the deposit workflow is finalized.

## Withdrawals

Withdrawal functionality is available through the TypeScript SDK and Canton integration.

Detailed integration examples will be added once the withdrawal workflow is finalized.
...
{/* TODO(SDK): Replace the legacy Aptos deposit and withdrawal flows with the current Canton integration once the SDK implementation is available. */}