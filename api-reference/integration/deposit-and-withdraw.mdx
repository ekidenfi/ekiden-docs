...
Ekiden uses a smart contract-based margin bank to custody collateral for trading. Users can deposit USDCx to the margin bank and withdraw available (free) collateral at any time. All deposits and withdrawals are on-chain but occur on Canton.
...
Check the documentation for the most current list of supported collateral assets.
...
Deposit and withdrawal integrations for Canton are being finalized. Updated integration instructions and SDK examples will be added once available.
