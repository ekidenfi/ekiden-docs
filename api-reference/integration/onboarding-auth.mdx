...
- `nonce`: random, unique per request (replay-protected per public\_key)
...
## 5) Use the token for private WebSocket
...
- 400 on /authorize: check signature, timestamp\_ms freshness, and nonce uniqueness.
