...
description: Standards and practices for using Ekiden's REST and WebSocket APIs.
---
...
- **Mainnet**: [`https://api.ekiden.exchange`](https://api.ekiden.exchange)  
- **Testnet**: [`https://testnet-api.ekiden.exchange`](https://testnet-api.ekiden.exchange)
