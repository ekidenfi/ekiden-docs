...
- **Mainnet**: `https://api.ekiden.fi/api`
- **Testnet**: [`https://testnet-api.ekiden.fi/api`](https://testnet-api.ekiden.fi/api)
...
Mainnet: wss[<u>://api.ekiden.fi/</u>](https://api.ekiden.fi/api)<u>ws</u>\
Testnet: wss://api.staging.ekiden.fi/ws
