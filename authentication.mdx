...
| 2 | Generate an **Ed25519** signature over `EKIDEN_WS|AUTH|{timestamp_ms}|{nonce}` using your **API private key**. |
| 3 | Send an `auth_api_key` message to the **private WebSocket** (`/ws/private`). |
