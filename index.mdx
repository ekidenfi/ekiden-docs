...
Ekiden is a decentralized, orderbook-based hybrid exchange built on Canton Network blockchain. It combines an off-chain Central Limit Orderbook (CLOB) with deferred on-chain settlement to deliver high performance, transparency, and capital efficiency for perpetual futures trading.
...
- **Price Discovery**: Powered by an off-chain Central Limit Order Book (CLOB).
