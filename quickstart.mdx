...
<CardGroup cols={2}>
  <Card title="Typescript SDK" icon="file" href="https://api-docs.ekiden.fi/api-reference/SDKs">
    A full-featured SDK for Node.js and browser environments.
  </Card>
  <Card title="Python SDK" icon="square-code" href="https://api-docs.ekiden.fi/api-reference/SDKs">
    Ideal for trading bots, analytics, and algorithmic strategies.
  </Card>
  <Card title="Rust SDK" icon="image" href="https://api-docs.ekiden.fi/api-reference/SDKs">
    Designed for high-performance, low-latency applications.
  </Card>
  <Card title="API Reference" icon="puzzle-piece" href="https://api-docs.ekiden.fi/api-reference/auth/authorize">
