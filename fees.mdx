...
<Note>
  During the Private Mainnet period, we lower the fees, making them as low as **0.01% for the maker**, **0.0350% for the taker**, which corresponds to the standard \$10M+ tier. 
</Note>
